    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location_lat', models.FloatField(blank=True, help_text='Last known latitude', null=True)),
                ('location_lng', models.FloatField(blank=True, help_text='Last known longitude', null=True)),
                ('is_whatsapp_user', models.BooleanField(default=False, help_text='Registered via WhatsApp')),
                ('whatsapp_number', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                ('profile_image', models.ImageField(blank=True, null=True, upload_to='profiles/')),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('gender', models.CharField(blank=True, choices=[('male', 'Male'), ('female', 'Female'), ('other', 'Other')], max_length=10)),
                ('blood_group', models.CharField(blank=True, help_text='e.g. A+, B-, O+', max_length=5)),
